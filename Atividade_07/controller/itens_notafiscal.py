...
from Atividade_07 import app
from Atividade_07.controller import objeto_json, response
from Atividade_07.model import select_objeto, banco_adicionar, banco_remover
from Atividade_07.model.tabelas import ItemNotaFiscal, NotaFiscal, Produto
